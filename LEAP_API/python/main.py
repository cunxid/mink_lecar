...
class LeapNode:
    def __init__(self, torque_switch=True):
        ...
        try:
            self.dxl_client = DynamixelClient(motors, '/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAA0B8A-if00-port0', 4000000)
...
def main(**kwargs):
    ...
    while True:
        ...
        # example output:
#         Position: [3.1507967 3.1277869 3.1339228 4.2844086 3.124719  3.1308548 3.1277869
#  3.1308548 3.1446607 3.1308548 3.1277869 3.1339228 3.1339228 3.1369908
#  3.1431267 3.1400588]
        time.sleep(0.03)
